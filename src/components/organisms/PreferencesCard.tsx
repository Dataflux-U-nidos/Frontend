...
export function PreferencesCard({ preferences }: PreferencesCardProps) {
  return (
    <Card className="bg-amber-100 shadow-md border-0 rounded-2xl overflow-hidden h-full">
        ...
        {preferences.map(({ label, icon, color }) => {
          ...
          return (
            <div key={label} className="flex items-center gap-3">
              <div className={`w-8 h-6 rounded-full bg-white shadow-sm flex items-center justify-center`}>
